...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Ubah Data pemilih</h3>
                    <div class="tile-body">
                        <form action="<?= base_url('admin/pemilih/simpanUbah'); ?>" method="POST">
                            <?php foreach ($cari as $data) : ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="nama" type="text" placeholder="Nama pemilih" value="<?= $data->nama_pemilih; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="username" value="<?= $data->username; ?>"></input>
                                </div>
                                <div class="form-group">
