        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form action="<?= base_url('admin/petugas/simpanUbah'); ?>" method="POST">
                            <?php
                            foreach ($cari as $data) : ?>
                                <input type="hidden" name="kode" value="<?= $data->id_petugas; ?>">
                                <div class="form-group">
                                    <label class="control-label">Nama Petugas</label>
                                    <input class="form-control" name="nama" type="text" placeholder="Nama Petugas" value="<?= $data->nama_petugas; ?>">
                                </div>
                                <div class="form-group">
